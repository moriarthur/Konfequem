...
class TestJWTAuthentication:
    ...
    def test_token_obtain_invalid_username(self, db, api_client):
        ...
        response = api_client.post(
            "/api/token/", {"username": "nonexistent", "password": "testpass123"}
        )
    ...
    def test_token_obtain_invalid_password(self, db, api_client):
        ...
        response = api_client.post(
            "/api/token/", {"username": "testuser", "password": "wrongpass"}
        )
    ...
    def test_token_obtain_empty_credentials(self, db, api_client):
        ...
        response = api_client.post("/api/token/", {"username": "", "password": ""})
    ...
    def test_token_refresh_success(self, db, api_client):
        ...
        response = api_client.post("/api/token/refresh/", {"refresh": str(refresh)})
    ...
    def test_token_refresh_invalid_token(self, db, api_client):
        ...
        response = api_client.post("/api/token/refresh/", {"refresh": "invalid-token"})
    ...
    def test_token_works_for_booking_operations(
        self, db, api_client, user, room, future_start_time
    ):
