...
interface RoomFiltersProps {
  ...
  onFilterChange?: (typeOrReset: string | ActiveFilters, value?: number | number[] | null) => void;
}
...
export default function RoomFilters({
  ...
  const hasActiveFilters =
    activeFilters.capacity !== null || (activeFilters.features && activeFilters.features.length > 0);
